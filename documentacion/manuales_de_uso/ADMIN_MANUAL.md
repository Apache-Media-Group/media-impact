...
## 🔧 6. Troubleshooting e Integración de APIs Avanzada
Para casos donde la ingesta falla de forma persistente, y se requiere debuggear los errores de API subyacentes o entender a fondo cómo actúan los conectores para Google Analytics 4, Adobe Analytics, Peec.ai y Brandlight:
* **Guías de Troubleshooting:** [documentacion/troubleshooting](/Users/santiagorovira/media_impact/documentacion/troubleshooting/)
* **Documentación Extendida de APIs:** [documentacion/troubleshooting/integracion_apis](/Users/santiagorovira/media_impact/documentacion/troubleshooting/integracion_apis/) (Contiene la estructura esperada de los JSON de autenticación, métodos de mitigación de límites de cuota (HTTP 429) y manejo de errores HTTP 403).
