# Metodología Legacy: Cálculos de KPIs de Tráfico de Alta Intención (High Intent Traffic)

Este documento detalla la metodología base ("legacy") extraída del repositorio original `AIMA_2-0`, utilizada en la herramienta **AI-2 Analytics MCP (GA4/Adobe)** para calcular los KPIs fundamentales que determinan la calidad, intención y grado de confianza del tráfico referido por Inteligencia Artificial.
