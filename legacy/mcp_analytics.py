...
from app.shared.auth_utils import TokenManager, RBACManager, get_effective_redirect_uri, get_backend_callback_url
...
async def oauth_login(request: Request, provider: str = "google"):
    ...
    if provider == "google":
        ...
        from app.shared.auth_utils import GoogleOAuth2Helper, OAuthStateManager
